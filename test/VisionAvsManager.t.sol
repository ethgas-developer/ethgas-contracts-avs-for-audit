...
import {VisionAvsDeploymentLib} from "../script/utils/VisionAvsDeploymentLib.sol";
...
contract VisionAvsTaskManagerSetup is Test {
    ...
    VisionAvsDeploymentLib.DeploymentData internal visionAvsDeployment;
    ...
    function setUp() public virtual {
        ...
        Vm.Wallet memory randomWallet = vm.createWallet("random");
        visionAvsDeployment =
            VisionAvsDeploymentLib.deployContracts(proxyAdmin, randomWallet.addr, randomWallet.addr, coreDeployment, quorum);
        labelContracts(coreDeployment, visionAvsDeployment);
    }
    ...
    function labelContracts(
        ...
        VisionAvsDeploymentLib.DeploymentData memory visionAvsDeployment
    ) internal {
        ...
        vm.label(visionAvsDeployment.ethgasVisionAvsManager, "EthgasVisionAvsManager");
        vm.label(visionAvsDeployment.stakeRegistry, "StakeRegistry");
    }
    ...
    function registerOperatorToAVS(
        ...
        bytes32 operatorRegistrationDigestHash = avsDirectory
            ...
            operator.key.addr, address(visionAvsDeployment.ethgasVisionAvsManager), salt, expiry
        );
...
contract VisionAvsManagerInitialization is VisionAvsTaskManagerSetup {
    function testInitialization() public view {
        ...
        assertTrue(visionAvsDeployment.stakeRegistry != address(0), "StakeRegistry not deployed");
        assertTrue(
            visionAvsDeployment.ethgasVisionAvsManager != address(0),
            "EthgasVisionAvsManager not deployed"
        );
...
contract RegisterOperator is VisionAvsTaskManagerSetup {
    ...
    EthgasVisionAvsManager internal sm;
    ...
    function setUp() public virtual override {
        ...
        sm = EthgasVisionAvsManager(visionAvsDeployment.ethgasVisionAvsManager);
