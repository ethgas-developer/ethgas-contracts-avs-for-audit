...
library CoreDeploymentLib {
    ...
    struct DeploymentData {
        ...
        address strategyLseth;
        address strategyEthx;
        address strategyReth;
        address strategyOseth;
        address strategyCbeth;
        address strategyAnkreth;
        address strategyEo;
        address strategySteth;
        address strategyWeth;
        address strategySfrxeth;
    ...
    function readDeploymentJson(
        ...
        data.strategyOseth = json.readAddress(".addresses.strategyOseth");
        data.strategyCbeth = json.readAddress(".addresses.strategyCbeth");
        data.strategyAnkreth = json.readAddress(".addresses.strategyAnkreth");
        data.strategyEo = json.readAddress(".addresses.strategyEo");
        data.strategySteth = json.readAddress(".addresses.strategySteth");
        data.strategyWeth = json.readAddress(".addresses.strategyWeth");
        data.strategySfrxeth = json.readAddress(".addresses.strategySfrxeth");
